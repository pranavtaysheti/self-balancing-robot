 ...
 *
 * ACC_CONFIG_[0,1,2,3] range = +- [    2,   4,   8,  16] times the gravity
 * (9.81 m/s^2) sensi =    [16384,8192,4096,2048] bit/gravity
 */

#ifndef _MPU6050_LIGHT_H
#define _MPU6050_LIGHT_H
...
public:
  ...
  // INLOOP UPDATE
  void
  fetchData(); // user should better call 'update' that includes 'fetchData'
  void update();
